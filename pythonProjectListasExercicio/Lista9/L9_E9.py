...
Exemplo: Data: 01/01/2020, Imprimir: 1 de janeiro de 2020. Faça funções para retornar a data por extenso e
utilize as funções do 7º exercício para validar a entrada da data.'''
